...
#                      "#include <stddef.h>\n#include <stdint.h>\n\n")
        ...
        for p in s3m.patterns:
            ...
            fileout.write(f"static const u8 {song_name}_{pattern}[] = {{\n")
        ...
        fileout.write(f"const u8 {song_name}_init_state[] = {{\n")
        ...
        fileout.write(f"const u8 *{song_name}[] = {{\n")
