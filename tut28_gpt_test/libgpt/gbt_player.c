...
// 2023/05/28 outside the function. gbt_frequencies
...
//---------------------------------------------------------------------------
// 2023/05/08 added
unsigned char gbt_get_ch1_arpeggio_freq_index0(void)
{
	return gbt.ch1.arpeggio_freq_index[0];
}

unsigned char gbt_get_ch2_arpeggio_freq_index0(void)
{
	return gbt.ch2.arpeggio_freq_index[0];
}

unsigned char gbt_get_ch3_arpeggio_freq_index0(void)
{
	return gbt.ch3.arpeggio_freq_index[0];
}
